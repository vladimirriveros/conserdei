...
<li class="nav-item dropdown user-menu">
    ...
    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        {{-- <li class="user-footer">
            ...
            @endif
            <a href="{{ route('password.change') }}" class="nav-link btn btn-default btn-flat d-inline-block">
        ...
        <li class="user-footer">
            <div style="display: flex; flex-direction: column; gap: 5px;">
                @if ($profile_url)
                    <a href="{{ $profile_url }}" class="btn btn-default btn-flat btn-block text-left">
                        <i class="fa fa-fw fa-user text-lightblue"></i>
                        Perfil
                    </a>
                @endif
                <a href="{{ route('password.change') }}" class="btn btn-default btn-flat btn-block text-left">
                    <i class="fa fa-fw fa-key text-warning"></i>
                    Cambiar Contraseña
                </a>
                <a class="btn btn-default btn-flat btn-block text-left" href="#"
